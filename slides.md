...
<div data-external-html="images/ricardo_table.html"></div>
...
- Relative Kosten: Auf wie viele Tonnen Tuch muss ich verzichten, wenn ich eine zusätzliche Tonne Wein produziere?
...
- **Hinweis:** Dieses stark vereinfachende Modell abstrahiert von jeglichen Transaktionskosten des Handels
...
<div data-external-html="images/capital_market1.html"></div>

*Abbildung 6: Kapitalmarktgleichgewicht*

Notes:
- Vertikal: Zins; horizontal: Ersparnisse und Investitionen (z. B. in USD)
...
- **Woher kommt die Differenz? Welche Bedeutung hat sie?**
...
- Es hilft, sich das Ganze noch einmal theoretisch anzusehen

--

<div data-external-html="images/capital_market2.html"></div>
...
![Transport durch globale Engpässe](images/panama_suez_trade_capacity.svg) \
...
- Die Reaktion der Schifffahrt ist nicht Stillstand, sondern Umleitung:
  Viele Schiffe fahren stattdessen um das Kap der Guten Hoffnung.
- Das verlängert Fahrzeiten, erhöht Treibstoffkosten, bindet Schiffskapazität und erhöht Frachtraten.
- Der Suezkanal bleibt formal offen, wird aber wegen Risiko, Versicherungskosten und Planungsunsicherheit deutlich weniger genutzt.
- Wichtig: Die Grafik zeigt Transitvolumen durch Suez, nicht das gesamte globale Handelsvolumen.
...
größeren CO₂-Emissionen einhergeht
...
- Aktuelles Beispiel: Geringe Wassertiefe im Panama-Kanal (El Niño)
...
- Abhängigkeit von China:
    ...
    - Großer Anteil an Lithium- und Kobaltvorkommen und an der Weiterverarbeitungsindustrie
...
- Wissenschaftliche Fachzeitschriften als Quelle erwünscht
